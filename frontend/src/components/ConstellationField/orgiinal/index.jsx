...
const Field = ({ fieldTexture, representatives, selectedRepresentative, onSelectionChange, onPositionChange, onDragChange, canMove }) => {
  ...
  const { handleRepresentativeSelect } = useContext(ConstellationContext);
  ...
  // Definir a função finalHandleSelect para evitar ReferenceError
  const finalHandleSelect = handleSelect;
