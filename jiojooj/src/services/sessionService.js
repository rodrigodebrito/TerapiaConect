...
export const markSessionCompleted = async (sessionId) => {
  try {
    ...
    const response = await api.put(`/api/sessions/${sessionId}/complete`);
...
export const startSession = async (sessionId) => {
  try {
    ...
    const response = await api.put(`/api/sessions/${sessionId}/start`);
...
export const createRobustSession = async (appointmentData) => {
  try {
    ...
    const response = await api.post('/api/sessions', sessionPayload);
    return response.data;
  } catch (error) {
    throw error;
  }
...
export const createTestSession = async () => {
  try {
    const response = await api.post('/api/sessions/test');
    return response.data;
  } catch (error) {
    throw error;
  }
